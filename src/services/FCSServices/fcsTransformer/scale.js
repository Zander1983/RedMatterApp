...
Scale.prototype.hasSpilloverForParam = function(params){
    ...
    } else if (Array.isArray(this.spilloverParams) && !isNaN(this.spilloverParams[0])) {
        // if its 1, 2, 3
...
Scale.prototype.memoizedScaleValueAccordingToFile = memoize(Scale.prototype.scaleValueAccordingToFile, { length: 4 });
