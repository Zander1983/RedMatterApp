...
const ulp = function (x) {
  return x < 0 ? nextUp(x) - x : x - -nextUp(-x);
};

function Logicle(max, calculatedW) {
  //−W ≤ A ≤ M − 2W,
...
Logicle.prototype.solve = function solve(b, w) {
  // w == 0 means its really arcsinh
  if (w == 0) return b;

  // precision is the same as that of b
  var tolerance = 2 * ulp(b);
 ...
 */
Logicle.prototype.slope = function (scale) {
 ...
 */
Logicle.prototype.seriesBiexponential = function (scale) {
 ...
 */
Logicle.prototype.scale = function (value) {
  ...
  var tolerance = 3 * ulp(1.0);
  if (x > 1) tolerance = 3 * ulp(x);
 ...
 */
Logicle.prototype.inverse = function (scale) {
  // reflect negative scale regions
...
// console.log('logicle.scale(-75) is ', logicle.scale(-75));

// console.log('logicle.scale(-20) is ', logicle.scale(-75));

// console.log('logicle.scale(-1) is ', logicle.scale(-75));

// console.log('logicle.scale(0) is ', logicle.scale(0));

// console.log('logicle.scale(20) is ', logicle.scale(20));

// console.log('logicle.scale(200000) is ', logicle.scale(200000));

// console.log('logicle.scale(262144) is ', logicle.scale(262144));
