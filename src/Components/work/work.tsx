        ...
        <div className="workHolder">
          <Row gutter={[8, 8]}>
            ...
            >
              ...
              <p>
                4.From you mobile, tablet or laptop, instantly start analysing
                your flow cytometry files
              </p>
              <p>
                5.To draw gates on a laptop, use the mouse. On mobile, use touch
              </p>
            ...
            >
              <div className="image">
                <Image width={400} src={tablet_s} preview={false} />
              </div>
            </Col>
          </Row>
        </div>
