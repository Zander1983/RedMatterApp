...
export default function Plans(props : any) {
    ...
    return (
        <div>
          <ChangeSubscriptionModal open={openChange} refresh={refresh} close={closeModal} updateSubscription={changeSubscription} subscription={subscriptionSend} subSelect={subSelect}></ChangeSubscriptionModal>
          <CancelSubscriptionModal open={openCancel} refresh={refresh} close={closeModal} cancelSubscription={cancelSubscription} subscription={subscriptionSend}></CancelSubscriptionModal>
            ...
            <Grid container
                    ...
                    <Grid item
                        ...
                        {product == null ? null : (product.name == "You are not currently Subscribed" ? null : (
                          ...
                          <Button style={
                              ...
                              color="secondary"
                              onClick={() => setOpenChange(true)}>Change Subscription</Button>
                      </div>
                        ))
                        }
                ...
                <Grid container
                    ...
                    <Grid item
                        ...
                        sm={6}>
                            {product == null ? null : (
                                product.name == "You are not currently Subscribed" ? (<h4>Go to <NavLink to="/plans">Plans </NavLink>to Subscribe</h4>) : (
                                    <div>
                                    <Button style={
                                            {marginTop: 25}
                                        }
                                        color="secondary"
                                        variant="contained"
                                        onClick={() => setOpenCancel(true)}>Cancel Subscription</Button>
                                </div>
                                  )
                            )}
