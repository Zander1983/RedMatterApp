...
import staticFileReader from "graph/old/components/modals/staticFCSFiles/staticFileReader";
...
import WorkspaceStateHelper from "graph/old/dataManagement/workspaceStateReload";
...
function Workspace(props: { experimentId: string }) {
  const workspace: WorkspaceType = props.store.workspace;
