    ...
    return (
        <TableContainer component={Paper} className={classes.container}>
            <Table style={{ overflowY: "scroll" }}>
                <PlotHeadComponent workspace={workspace} />
                <TableBody>
                    {workspace?.files?.map((file, i) => (
                        <>
                            <PlotRowComponent
                                ...
                                workspace={workspace} workspaceLoading={workspaceLoading}
                                customPlotRerender={customPlotRerender} file={file} />
                        </>
                    ))}
                </TableBody>
            </Table>
